 ...
 *
 * ShowCoins_CloudCoin currently has no differences from CloudCoin.
 *
 * @author Sean H. Worthington
 * @version 1/9/2016
 */
class ShowCoins_CloudCoin
{
    // instance variables
    /***
     ...
     */
    public ShowCoins_CloudCoin(int nn, int sn, String[] ans, String ed, Dictionary aoid, String extension  )
    ...
    public ShowCoins_CloudCoin( )//Default constructor
    {
    }
    /**
     * CloudCoin Constructor
