...
class ShowCoins_FileUtils
{
    ...
    public ShowCoins_CloudCoin cloudCoinFromFile( String loadFilePath ) throws FileNotFoundException, IOException {
        String extension ="";
        ShowCoins_CloudCoin cc = new ShowCoins_CloudCoin();
     ...
     */
    public String setJSON( ShowCoins_CloudCoin cc){
     ...
     */
    public byte[] makeJpeg( ShowCoins_CloudCoin cc){
    ...
    public boolean writeTo( String folder, ShowCoins_CloudCoin cc){
    ...
    private ShowCoins_CloudCoin parseJpeg( String wholeString){
        ShowCoins_CloudCoin cc = new ShowCoins_CloudCoin();
        int startAn = 40;
        int endAn = 72;
        for(int i = 0; i< 25; i++){
